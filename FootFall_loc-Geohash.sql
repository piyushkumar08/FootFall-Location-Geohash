...
ALTER table [DataDB].[dbo].[footfallsSample]
add Geohash varchar(10)

UPDATE [DataDB].[dbo].[footfallsSample]
SET Geohash= dbo.geohash_encode( latitude, longitude, 6)

SELECT TOP(50) *
FROM [DataDB].[dbo].[footfallsSample]

ALTER table [DataDB].[dbo].[location]
add Geohash varchar(10)

UPDATE [DataDB].[dbo].[location]
SET Geohash = dbo.geohash_encode(lat,long,6)

SELECT TOP(50) *
FROM [DataDB].[dbo].[location]
